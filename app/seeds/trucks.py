...
def seed_trucks():
    ...
    truck2 = Truck(owner_id=1, name="Dogtown Dogs", address="", city="Los Angeles", state="California", zip_code="", cuisine="Sandwiches", price="$$$$", lat=None, long=None, created_at=datetime.now(), updated_at=datetime.now())
    truck3 = Truck(owner_id=1, name="Guerrilla Tacos", address="", city="Los Angeles", state="California", zip_code="", cuisine="Tacos/Burritos", price="$$", lat=None, long=None, created_at=datetime.now(), updated_at=datetime.now())
    truck4 = Truck(owner_id=1, name="Nitro Coffee", address="", city="Los Angeles", state="California", zip_code="", cuisine="Coffee", price="$", lat=None, long=None, created_at=datetime.now(), updated_at=datetime.now())
    truck5 = Truck(owner_id=1, name="Wood Shop BBQ", address="", city="Seattle", state="Washington", zip_code="", cuisine="BBQ", price="$$", lat=None, long=None, created_at=datetime.now(), updated_at=datetime.now())

    truck6 = Truck(owner_id=2, name="Yeti Dogs", address="", city="Seattle", state="Washington", zip_code="", cuisine="Sandwiches", price="$", lat=None, long=None, created_at=datetime.now(), updated_at=datetime.now())
    truck7 = Truck(owner_id=2, name="Uncle John's BBQ", address="", city="Seattle", state="Washington", zip_code="", cuisine="BBQ", price="$$", lat=None, long=None, created_at=datetime.now(), updated_at=datetime.now())
    truck8 = Truck(owner_id=2, name="Cold Cookie Co.", address="", city="Austin", state="Texas", zip_code="", cuisine="Ice Cream", price="$", lat=None, long=None, created_at=datetime.now(), updated_at=datetime.now())
    truck9 = Truck(owner_id=2, name="Hey Cupcake!", address="", city="Austin", state="Texas", zip_code="", cuisine="Dessert", price="$$", lat=None, long=None, created_at=datetime.now(), updated_at=datetime.now())
    truck10 = Truck(owner_id=2, name="Dawa Sushi", address="", city="Austin", state="Texas", zip_code="", cuisine="Sushi", price="$$$", lat=None, long=None, created_at=datetime.now(), updated_at=datetime.now())
