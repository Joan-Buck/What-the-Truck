...
class FoodTruckForm(FlaskForm):
    ...
    state = SelectField("state", validators=[InputRequired(message="Please select 1 US state for your food truck.. Our app is currently only serving US based food trucks.")],
