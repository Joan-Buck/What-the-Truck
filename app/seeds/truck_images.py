...
def seed_truck_images():
    ...
    # image7 = TruckImage(truck_id=7, image_url="", created_at=datetime.now(), updated_at=datetime.now())
    ...
    image11 = TruckImage(truck_id=11, image_url="https://indianfoodny.com/img/delicious/GrandBazaar.png", created_at=datetime.now(), updated_at=datetime.now())
    image12 = TruckImage(truck_id=12, image_url="https://infatuation.imgix.net/media/images/reviews/king-souvlaki-of-astoria/banners/1606243773.6297815.png", created_at=datetime.now(), updated_at=datetime.now())
    # image13 = TruckImage(truck_id=13, image_url="", created_at=datetime.now(), updated_at=datetime.now())
    ...
    image15 = TruckImage(truck_id=15, image_url="https://madeinpgh.com/wp-content/uploads/2021/04/image.jpeg", created_at=datetime.now(), updated_at=datetime.now())
    ...
    image17 = TruckImage(truck_id=17, image_url="https://d3hbe0kmbam4a5.cloudfront.net/photos/ca89150d-49d0-4e26-89b6-d73513283253.jpg", created_at=datetime.now(), updated_at=datetime.now())
